...
Documentation is divided into two strictly separate domains:
...
domain keeps its own decision and the two pages reference one another.

New ADRs use the [shared template](templates/adr.md) but live in the registry of
the domain they concern.
